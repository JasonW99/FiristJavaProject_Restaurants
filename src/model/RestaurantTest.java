...
public class RestaurantTest {
	...
	@Before
	public void setUp() {
		restaurant = new Restaurant("yam-leaf-bistro-mountain-view", 
				"Yam Leaf Bistro", 
	...
	/**
	 * This test fixture uses setUp() to prepare the expected Restaurant object before EACH @Test, and uses tearDown() to print the test name after EACH @Test.
	 * If we want something done only ONCE for the entire test class, you can use:
	 * ---------------------------------------
	 * @BeforeClass
